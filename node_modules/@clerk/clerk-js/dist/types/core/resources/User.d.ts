import type { BackupCodeResource, ClerkPaginatedResponse, CreateEmailAddressParams, CreateExternalAccountParams, CreateMeEnterpriseConnectionParams, CreatePhoneNumberParams, CreateWeb3WalletParams, DeletedObjectResource, EmailAddressResource, EnterpriseAccountResource, EnterpriseConnectionResource, EnterpriseConnectionTestRunInitResource, EnterpriseConnectionTestRunResource, ExternalAccountResource, GetEnterpriseConnectionsParams, GetEnterpriseConnectionTestRunsParams, GetOrganizationMemberships, GetUserOrganizationInvitationsParams, GetUserOrganizationSuggestionsParams, ImageResource, OrganizationMembershipResource, PasskeyResource, PhoneNumberResource, RemoveUserPasswordParams, SetProfileImageParams, TOTPResource, UpdateMeEnterpriseConnectionParams, UpdateUserParams, UpdateUserPasswordParams, UserJSON, UserJSONSnapshot, UserResource, VerifyTOTPParams, Web3WalletResource } from '@clerk/shared/types';
...
export declare class User extends BaseResource implements UserResource {
    ...
    getOrganizationInvitations: (params?: GetUserOrganizationInvitationsParams) => Promise<ClerkPaginatedResponse<UserOrganizationInvitation>>;
    getOrganizationSuggestions: (params?: GetUserOrganizationSuggestionsParams) => Promise<ClerkPaginatedResponse<OrganizationSuggestion>>;
