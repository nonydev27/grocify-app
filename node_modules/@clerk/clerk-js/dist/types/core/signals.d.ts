...
export declare const waitlistResourceSignal: {
    (): {
...
export declare const waitlistErrorSignal: {
    (): {
        error: ClerkError | null;
    };
    (value: {
...
export declare const waitlistFetchSignal: {
    (): {
        status: "idle" | "fetching";
    };
    (value: {
...
export declare const waitlistComputedSignal: WaitlistSignal;
/**
