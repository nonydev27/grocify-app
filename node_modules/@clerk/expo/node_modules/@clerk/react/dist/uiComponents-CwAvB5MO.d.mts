...
import { Without, APIKeysProps, CreateOrganizationProps, OrganizationListProps, OrganizationProfileProps, OrganizationSwitcherProps, SignInProps, SignUpProps, TaskChooseOrganizationProps, TaskResetPasswordProps, TaskSetupMFAProps, UserAvatarProps, UserButtonProps, UserProfileProps, WaitlistProps, __experimental_ConfigureSSOProps } from '@clerk/shared/types';
...
declare const ConfigureSSO: {
    (props: Without<WithClerkProp<__experimental_ConfigureSSOProps & FallbackProp>, "clerk">): React.JSX.Element | null;
    displayName: string;
};
...
export { APIKeys as A, ConfigureSSO as C, GoogleOneTap as G, OAuthConsent as O, PricingTable as P, SignIn as S, TaskChooseOrganization as T, UserAvatar as U, Waitlist as W, CreateOrganization as a, OrganizationList as b, OrganizationProfile as c, OrganizationSwitcher as d, SignUp as e, TaskResetPassword as f, TaskSetupMFA as g, UserButton as h, UserProfile as i };
